...
const snake = {
     ...
     * @param maxX {int} Максимальная позиция змейки по X
     * @param maxY {int} Максимальная позиция змейки по Y
     */
    ...
    getNextStepHeadPoint() {
        ...
        let nextHeadPoint = null;
        switch (this.direction) {
            case 'up':
                nextHeadPoint = {x: firstPoint.x, y: firstPoint.y !== 0 ? firstPoint.y - 1 : this.maxY};
                break;
            case 'right':
                nextHeadPoint = {x: firstPoint.x !== this.maxX ? firstPoint.x + 1 : 0, y: firstPoint.y};
                break;
            case 'down':
                nextHeadPoint = {x: firstPoint.x, y: firstPoint.y !== this.maxY ? firstPoint.y + 1 : 0};
                break;
            case 'left':
                nextHeadPoint = {x: firstPoint.x !== 0 ? firstPoint.x - 1 : this.maxX, y: firstPoint.y};
                break;
        }
